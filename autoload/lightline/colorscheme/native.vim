...
let s:p.normal.left     = [ [ s:color00, s:color04 ], [ s:color00, s:color07 ] ]
let s:p.insert.left     = [ [ s:color00, s:color02 ], [ s:color00, s:color07 ] ]
let s:p.visual.left     = [ [ s:color00, s:color05 ], [ s:color00, s:color07 ] ]
let s:p.replace.left    = [ [ s:color00, s:color01 ], [ s:color00, s:color07 ] ]
let s:p.inactive.left   = [ [ s:color07, s:color08 ] ]

let s:p.normal.middle   = [ [ s:color15, s:color08 ] ]
let s:p.inactive.middle = [ [ s:color07, s:color08 ] ]

let s:p.normal.right     = [ [ s:color00, s:color07 ], [ s:color00, s:color07 ] ]
let s:p.insert.right     = [ [ s:color00, s:color07 ], [ s:color00, s:color07 ] ]
let s:p.visual.right     = [ [ s:color00, s:color07 ], [ s:color00, s:color07 ] ]
let s:p.replace.right    = [ [ s:color00, s:color07 ], [ s:color00, s:color07 ] ]
let s:p.inactive.right   = [ [ s:color07, s:color08 ] ]
