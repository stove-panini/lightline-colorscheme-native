...
let s:p.inactive.middle = [ [ s:color15, s:color08 ] ]

let s:p.normal.right     = [ [ s:color00, s:color04 ], [ s:color00, s:color07 ] ]
let s:p.insert.right     = [ [ s:color00, s:color02 ], [ s:color00, s:color07 ] ]
let s:p.visual.right     = [ [ s:color00, s:color05 ], [ s:color00, s:color07 ] ]
let s:p.replace.right    = [ [ s:color00, s:color01 ], [ s:color00, s:color07 ] ]
